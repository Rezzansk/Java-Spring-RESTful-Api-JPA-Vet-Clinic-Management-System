...
public class StatisticsDto {
    ...
    public StatisticsDto(CustomerRepository cuRepo, CaseRepository caRepo, StorageRepository stRepo, VaccineRepository vacRepo, ProductRepository prRepo, PetRepository petRepo, CureRepository cureRepo, ScheduleCalendarRepository calRepo) {
        this.cuRepo = cuRepo;
        this.caRepo = caRepo;
        this.stRepo = stRepo;
